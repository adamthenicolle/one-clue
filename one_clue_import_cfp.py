...
## just put your file pathname here and press "run"

cfp_file_name = "/Users/steven/Desktop/CROSSWORDS ORGANIZED/LUCKYSTREAK/THEMELESS PUZZLES/weirdsizetest.cfp"

## the rest of the code

txt_file_name = cfp_file_name.replace(".cfp",".txt")

cfp_lines = []
cfp_file = open(cfp_file_name,encoding="utf-8").readlines()
end_file = txt_file_name
...
for line in grid_entries:
    if "-" in line:
        print("You fool! There are unfinished entries!")
        exit()
...
for line in across_just_clues:
    puz_txt.append(line)
puz_txt.append("")
append = puz_txt.append("<DOWN>")
for line in down_just_clues:
    puz_txt.append(line)
...
with open(end_file,"w") as puz_final:
    ...
    for line in new_across_clues:
        puz_final.write(line + '\n')
    puz_final.write('<DOWN>' + '\n')
    for line in new_down_clues:
        puz_final.write(line + '\n')
